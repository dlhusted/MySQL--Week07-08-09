...
public class ProjectsApp {
	...
	/*
	 * in recipes: 
	 * this is diplayMenu() method
	 * selection is operation = getoperation()
	 */
	...
	private void deleteProject() {
		...
		if(Objects.nonNull(projectId)) {
			...
			System.out.println("You have deleted the project " + projectId);
...
/*
 * see recipes video for method: addRecipe()
 */
